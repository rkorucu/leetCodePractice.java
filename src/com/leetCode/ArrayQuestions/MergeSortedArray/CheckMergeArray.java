...
class checkMergeArray {
    ...
    public static int[] mergeArrays(int[] arr1, int[] arr2) {
        int s1 = arr1.length;
        int s2 = arr2.length;
        //i--> for curent arr1 index position
        //j--. for current arr2 index psition
        //k--> result array current position
        int i = 0, j = 0, k = 0;
...
// This is for edge case.We have to check is there any number remaining in the array .Both of  arrays
